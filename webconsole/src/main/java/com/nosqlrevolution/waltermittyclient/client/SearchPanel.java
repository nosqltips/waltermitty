 ...
 *
 */
public class SearchPanel extends DockLayoutPanel implements ClickHandler, KeyUpHandler, FocusHandler, BlurHandler {
    /**
...
//    private SliderVerticalPanelPanel sliderVerticalPanelPanel;
    ...
    public SearchPanel(Style.Unit unit) {
        super(unit);
...
//        p.addNorth(northPanel, 5);
        ...
        addSouth(southPanel, 2);

//        p.addEast(new HTML("east"), 2);
        westPanel = new WestPanel();
        addWest(westPanel, 20);
...
//        westPanel.add(hp);  // put member id entry field at bottom of west panel?
...
//                sliderVerticalPanelPanel.clear();
            ...
            public void onSuccess(SearchQuery searchQuery)
            {
                ...
                SearchPanel.this.searchQuery = searchQuery;
                facetContainer.clear();
